...
window.CalendarModule = {
  ...
  getTodayDateStr: function() {
    if (window.dataManager && window.dataManager.getTodayDateStr) {
      return window.dataManager.getTodayDateStr();
    }
    const d = new Date();
  ...
  bindEvents: function() {
    ...
    if (triggerBtn && popover) {
      triggerBtn.onclick = null; // Clear legacy handler
...
window.Calendar = window.CalendarModule;
