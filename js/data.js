...
,
  ...
  },
  {
    ...
    subject: "社會/地理",
    errorReason: "觀念不懂",
    concept: "二十四節氣時間判讀與梅雨（滯留鋒面）成因",
    uploadDate: "2026-09-06",
    mondayDate: "2026-08-24",
    mondayDates: ["2026-08-24"],
    weekLabel: "2026-08-24 (暑假複習)",
    isGuessedOrUnstable: true,
    mistakeNote: "立夏（約5/5~5/7）、小滿（約5/20~5/22）落在陽曆五月中下旬，此時臺灣正逢冷暖氣團交會形成的「滯留鋒面」（梅雨期），連續降雨，故稱「立夏小滿，雨水相趕」！",
    stem: "「立夏小滿，雨水相趕」這句諺語是形容臺灣每年逢立夏、小滿二節氣時，經常下雨，雨水紛至。根據附表二十四節氣的時間判斷，此時降雨的最主要成因為下列何者？\n\n| 陽曆月份 | 節氣 |\n| :--- | :--- |\n| 5 月至 7 月 | 立夏、小滿、芒種、夏至、小暑、大暑 |\n| 8 月至 10 月 | 立秋、處暑、白露、秋分、寒露、霜降 |\n| 11 月至 1 月 | 立冬、小雪、大雪、冬至、小寒、大寒 |\n| 2 月至 4 月 | 立春、雨水、驚蟄、春分、清明、穀雨 |\n\n○ (A) 夏季對流旺盛形成對流雨\n○ (B) 暖濕西南季風遇山脈阻擋抬升\n○ (C) 冷暖氣團在臺灣附近交會形成滯留鋒面\n○ (D) 熱帶低氣壓發展為颱風帶來的暴雨\n\n🎬 [點選看 YouTube 解題影片](https://www.youtube.com/watch?v=bjVUtUlgTqA)",
    answer: "(C) 冷暖氣團在臺灣附近交會形成滯留鋒面",
    diagramUrl: "assets/questions/q_soc_geo_solar_terms_005.png?v=36",
    solution: "1. **節氣時間推算**：\n- 根據表格，立夏與小滿為陽曆 5 月上旬至中下旬（立夏約 5/5、小滿約 5/21）。\n\n2. **氣候機制解析**：\n- 臺灣 5 月中旬至 6 月中旬為典型的**梅雨季節**。\n- 此時北方蒙古冷高壓逐漸減弱，南方太平洋暖高壓勢力增強，冷暖兩大氣團在臺灣及華南一帶交會，形成滯留鋒面，降雨綿延數日，故有「雨水相趕」之稱。\n\n3. **結論**：主要降雨成因為滯留鋒面，正確答案選 **(C)**。",
    errorCount: 1,
    ebbinghausStage: 1,
    consecutiveMastered: 0,
    isArchived: false,
  ...
  },
  {
    ...
    weekLabel: "2026-08-24 (暑假複習)",
    isGuessedOrUnstable: true,
    mistakeNote: "東北季風與夏季西南季風的迎風坡降雨豐沛。丁測站位於北緯24.8°N、東經121.7°N，位於臺灣東北部山區（宜蘭/新北山區），冬季迎東北季風、夏季迎對流雨與颱風，年降水量為全臺之冠！",
    stem: "臺灣本島的經緯度約介於 $22^\\circ\\text{N}\\sim 25^\\circ\\text{N}$，$120^\\circ\\text{E}\\sim 122^\\circ\\text{E}$ 之間，降水的空間分布受到地形及季風的影響而有顯著差異。附表為本島四個氣象測站的資料，根據各測站位置及地形判斷，何者的年降水量可能最多？【112年會考】\n\n| 測站 | 緯度 | 經度 | 高度（m） |\n| :---: | :---: | :---: | :---: |\n| 甲 | $23.98^\\circ\\text{N}$ | $121.61^\\circ\\text{E}$ | 19 |\n| 乙 | $23.57^\\circ\\text{N}$ | $120.31^\\circ\\text{E}$ | 27 |\n| 丙 | $22.68^\\circ\\text{N}$ | $120.50^\\circ\\text{E}$ | 33 |\n| 丁 | $24.83^\\circ\\text{N}$ | $121.78^\\circ\\text{E}$ | 362 |\n\n○ (A) 甲\n○ (B) 乙\n○ (C) 丙\n○ (D) 丁\n\n🎬 [點選看 YouTube 解題影片](https://www.youtube.com/watch?v=rBrKF9lroJU)",
    answer: "(D) 丁",
    diagramUrl: "assets/questions/q_soc_geo_weather_stations_004.png?v=36",
    solution: "1. **各測站地理位置比對**：\n- 甲（$23.98^\\circ\\text{N}, 121.61^\\circ\\text{E}$，19m）：花蓮沿海平原。\n- 乙（$23.57^\\circ\\text{N}, 120.31^\\circ\\text{E}$，27m）：嘉義/雲林西部平原。\n- 丙（$22.68^\\circ\\text{N}, 120.50^\\circ\\text{E}$，33m）：高屏平原。\n- 丁（$24.83^\\circ\\text{N}, 121.78^\\circ\\text{E}$，362m）：東北角山區（宜蘭/新北山地迎風坡）。\n\n2. **分析臺灣年降水量冠軍區位**：\n- 東北角山區為全臺雨量最多之處（如火燒寮年雨量達 6,000mm 以上）。\n- 丁測站位於東北部迎風坡，海拔 362 公尺，冬季面迎潮濕東北季風產生強烈地形雨，夏季則有颱風與對流雨，全年多雨，降水量最多。\n\n3. **結論**：正確答案選 **(D)**。",
    errorCount: 1,
    ebbinghausStage: 1,
    consecutiveMastered: 0,
    isArchived: false,
  ...
  },
  {
    ...
    answer: "(C) 丙",
    diagramUrl: "assets/questions/q_soc_geo_district_office_002.png?v=36",
  ...
  },
  {
    ...
    diagramUrl: "assets/questions/q_soc_geo_coastal_salt_pan_006.png?v=36",
  ...
  },
  {
    ...
    weekLabel: "2026-08-24 (暑假複習)",
    isGuessedOrUnstable: true,
    mistakeNote: "海報顯示家鄉人口外流（老人幼童為主）、從事養殖漁業魚塭，但「居民共同運用本地產品舉辦料理競賽、形成海產市集吸引大批遊客」，這正是居民凝聚向心力的「社區發展成果豐碩」！",
    stem: "附圖是小月在參與課堂活動時所製作的海報，根據海報內容判斷，下列哪一現象最可能在小月的家鄉出現？\n\n【我的家鄉】\n1. 人口結構：居民多為老人及幼童，大多數的年輕人都住在外地工作，只有逢年過節才返鄉。\n2. 產業類型：居民多從事養殖漁業的工作，路旁有各種魚塭，常能吃到新鮮的海產。\n3. 地方特色：居民共同運用本地產品，經常舉辦料理競賽，形成海產市集，帶來大批遊客，成為知名景點。\n\n○ (A) 以核心家庭型態為主\n○ (B) 居民多為原住民族群\n○ (C) 社區發展成果豐碩\n○ (D) 外來就業人口比例頗高\n\n🎬 [點選看 YouTube 解題影片](https://www.youtube.com/watch?v=p1poacaYT-g)",
    answer: "(C) 社區發展成果豐碩",
    diagramUrl: "assets/questions/q_soc_geo_poster_fishery_007.png?v=36",
    solution: "1. **海報內容關鍵訊息提取**：\n- 青年外流，隔代教養與老齡化顯著。\n- 居民積極組織料理競賽與海產市集，推廣地方創生，活化農漁村經濟。\n\n2. **選項剖析**：\n- (A) 青年外流，非核心家庭為主。\n- (B) 西南部養殖漁村多以漢人聚落為主，無法推斷為原住民族。\n- (C) 居民凝聚地方認同與向心力，促進地方繁榮，符合「社區發展成果豐碩」。\n- (D) 人口以流出為主，非外來人口高比例。\n\n3. **結論**：正確答案選 **(C)**。",
    errorCount: 1,
    ebbinghausStage: 1,
    consecutiveMastered: 0,
    isArchived: false,
  ...
  },
  {
    ...
    answer: "(D) 鹽田",
    diagramUrl: "assets/questions/q_soc_his_land_rent_001.png?v=36",
  ...
  },
  {
    ...
    stem: "如圖是小郁翻閱相關書籍所看到的部分內容。由於墨漬遮蔽了若干文字，請協助小郁判斷，下列何者最可能是遮蔽處的內容？【95年第1次基測】\n\n【書籍關係圖核心】\n- 法律與政治：女權運動、維護身體自主權、終止暴力侵害、普選權運動、女性享有投票權。\n- 社會與經濟：戰時男性勞動力短缺、家庭用品電器化（家務減輕）、教育機會增加、家庭規模縮減。\n\n○ (A) 改變婦女地位的因素\n○ (B) 縮小貧富差距的原因\n○ (C) 改善社會福利的背景\n○ (D) 強化性別分工的條件\n\n🎬 [點選看 YouTube 解題影片](https://www.youtube.com/watch?v=DCcXWdN7Qfo)",
    answer: "(A) 改變婦女地位的因素",
    diagramUrl: "assets/questions/q_soc_his_women_rights_ink_002.png?v=36",
  ...
  },
  {
    ...
    answer: "(B) 乙",
    diagramUrl: "assets/questions/q_soc_civ_aging_ratio_001.png?v=36",
  ...
  },
  {
    ...
    answer: "(A) J",
    diagramUrl: "assets/questions/q_soc_civ_id_letter_map_005.png?v=36",
  ...
  },
  {
    ...
    diagramUrl: "assets/questions/q_soc_civ_class_meeting_003.png?v=36",
  ...
  },
  {
    ...
    diagramUrl: "assets/questions/q_soc_civ_female_unemployed_008.png?v=36",
  ...
  },
  {
    ...
    stem: "附圖中甲、乙、丙、丁哪兩位同學的發言符合《會議規範》的規定？【107年會考】\n\n- 主席：「現在我宣布會議開始，請各位保持安靜……（台下同學持續嘰嘰喳喳喧鬧）」\n- 甲同學：「我要提權宜問題，應該先進行提案討論！」\n- 乙同學：「我要提權宜問題，應該處理目前場內喧嘩問題！」\n- 丙同學：「我要提秩序問題，應該處理目前場內喧嘩問題！」\n- 丁同學：「我要提秩序問題，應該先進行提案討論！」\n\n○ (A) 甲、丁\n○ (B) 乙、丙\n○ (C) 甲、丙\n○ (D) 乙、丁\n\n🎬 [點選看 YouTube 解題影片](https://www.youtube.com/watch?v=p1poacaYT-g)",
    answer: "(D) 乙、丁",
    diagramUrl: "assets/questions/q_soc_civ_meeting_rules_comic_004.png?v=36",
  ...
  },
  {
    ...
    stem: "請根據圖中內容判斷，下列何者為下圖所欲表達且更應受到重視的現代公民德性？\n\n【圖示意象】\n- 過去：一般群體站在前方高處享有絕大部分資源與視線，社會處境不利群體被遮擋在矮牆後方。\n- 現在及未來：主動為社會處境不利群體提供階梯與墊高平臺，使其享有平等的視野與基本生存機會。\n\n○ (A) 尊重友善包容\n○ (B) 促進族群融合\n○ (C) 遵守多數民主\n○ (D) 捍衛社會正義\n\n🎬 [點選看 YouTube 解題影片](https://www.youtube.com/watch?v=p1poacaYT-g)",
    answer: "(D) 捍衛社會正義",
    diagramUrl: "assets/questions/q_soc_civ_disadvantaged_justice_002.png?v=36",
  ...
  },
  {
    ...
    stem: "史前文化博物館舉辦「當代布農狩獵文化的意涵與挑戰」講座，附圖是該講座的引言：「早期原住民狩獵幾乎都是為了獲取足夠的生活資源，並非用來買賣；如今臺灣社會對原住民狩獵依然有部分誤解，例如扣上『濫殺』的大帽子，且狩獵文化和現行法律依然時常衝突，迄今還沒有達成共識。」根據引言內容所述，下列說明何者正確？\n\n○ (A) 原住民狩獵文化在當前臺灣社會已屬於主流文化\n○ (B) 說明了原住民族傳統風俗習慣與現代實定法律之間仍存在規範衝突\n○ (C) 臺灣主流社會已建立對原住民狩獵文化的全面包容與完全理解\n○ (D) 該講座的舉辦不利於原住民族狩獵傳統與文化的正面傳承\n\n🎬 [點選看 YouTube 解題影片](https://www.youtube.com/watch?v=p1poacaYT-g)",
    answer: "(B) 說明了原住民族傳統風俗習慣與現代實定法律之間仍存在規範衝突",
    diagramUrl: "assets/questions/q_soc_civ_bunun_hunting_quote_006.png?v=36",
  ...
  },
  {
    ...
    stem: "附圖是校園中交通安全週的標語：「生命無價，禮讓優先；開車不搶快，騎車不亂鑽。」張貼此標語的目的最可能是下列何者？【109年會考補考】\n\n○ (A) 因應全球化所造成的犯罪問題\n○ (B) 藉由宣導社會規範達成社會化\n○ (C) 推動社會運動來解決文化衝突\n○ (D) 透過社會團體來促成制度變遷\n\n🎬 [點選看 YouTube 解題影片](https://www.youtube.com/watch?v=p1poacaYT-g)",
    answer: "(B) 藉由宣導社會規範達成社會化",
    diagramUrl: "assets/questions/q_soc_civ_traffic_banner_007.png?v=36",
